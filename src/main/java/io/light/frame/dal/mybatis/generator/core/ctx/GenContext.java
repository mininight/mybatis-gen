...
public class GenContext {
    ...
    private GenContext(String module, MybatisGenProperties.GeneratorCfg config, TableMapper tableMapper,
                       DesignXml designXml) {
        this.module = module;
    ...
    public static GenContext create(String module, MybatisGenProperties.GeneratorCfg config, TableMapper tableMapper,
                                    DesignXml designXml) {
        if (CTX.get() != null) {
